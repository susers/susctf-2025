...
return array(
	...
	'db_user'	=> 'root',		//数据库用户名
	'db_pass'	=> 'seu@susctf@2025',			//数据库密码
	'db_base'	=> 'rockxinhu',	//数据库名称

	'randkey'	=> 'kraiegvnhsyqbjodpfcwxzumtl',			//系统密钥，必须填写(详见上面网址生成)
	...
	'highpass'	=> 'easyoa@susctf@2025',				//超级管理员密码，可用于登录任何帐号
	...
	'qcloudCos_SecretKey'	=> '114514',
	'alioss_keysecret'		=> '1919810',
);