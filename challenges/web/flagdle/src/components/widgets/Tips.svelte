<script context="module" lang="ts">
	const tips = [
		"You can change the gamemode by clicking FLAGDLE or swiping the board left or right.",
...
<div class="outer">
	...
	<svg class="left" on:click={previousTip} on:keydown={previousTip} xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 100 100">
		<path d="M75,0L25,50L75,100z" />
	</svg>
	<svg on:click={nextTip} on:keypress={nextTip} class="right" xmlns="http://www.w3.org/2000/svg"
		viewBox="0 0 100 100">
